...
const allCourses : Course[] = [
    {
        ...
        featured: true,
        openGraphUrl: "https://www.abdalfttah-academy.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fbootcamp.5a7cfdf0.jpg&w=1920&q=75",
        innerPage: {
            ...
            contentAr: [
                {
                    heading: "الجزء الاول: 7 محاضرات تعليمية",
                    contentPieces: [
                    {
                        button: "فهم المسارات الأكاديمية",
                        subList: [
                            "ماجستير، دكتوراه، باحث مساعد، تدريبات ، تمويل — وإزاي تختار الطريق المناسب ليك."
                        ]
                    },
                    {
                        button: "فين وإزاي تلاقي الفرص",
                        subList: [
                            "منح دراسية , برامج ممولة بالكامل, وظائف باحث مساعد, مواقع المعامل البحثية, المنصات الأكاديمية"
                        ]
                    },
                    {
                        button: "ماستر كلاس السيرة الذاتية الأكاديمية",
                        subList: [
                            "إزاي تكتب سيرة ذاتية أكاديمية قوية ومنافسة لتقديمات الماجستير والدكتوراه والباحث المساعد.",
                        ]
                    },
                    {
                        button: "مراسلة المشرفين الأكاديميين",
                        subList: [
                            "إزاي تلاقي المشرفين وتبعت إيميلات احترافية تجيب رد.",
                        ]
                    },
                    {
                        button: "بيان الغرض وخطاب الحافز وبيان الخطة البحثية",
                        subList: [
                            "إزاي تكتب مستندات تقديم مقنعة ومصممة على هدفك الأكاديمي.",
                        ]
                    },
                    {
                        button: "استراتيجية خطابات التوصية",
                        subList: [
                            "اختيار الموصين (Referees)،كتابة الخطابات، طلب الخطابات، والمتابعة باحتراف",
                        ]
                    },
                    {
                        button: "المقابلات، التأشيرة، السكن، والتخطيط المهني",
                        subList: [
                            "التحضير للمقابلات الأكاديمية، الانتقال للخارج، وبناء خطة مهنية طويلة المدى",
                        ]
                    },
                    ]
                },
                {
                    heading: "الجزء التاني: 7 جلسات تقييم شخصية",

                    contentPieces: [
                        {
                            button: "بعد كل محاضرة تعليمية، في جلسة تقييم مخصصة يحصل فيها الطلاب على:",
                            subList: [
                                "مراجعة السيرة الذاتية",
                                "تصحيح بيان الغرض (SOP) والإيميلات (Emails)",
                                "توجيه شخصي حسب الملف الأكاديمي",
